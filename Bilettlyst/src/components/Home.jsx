...
//findings
 ...
 //Tons of rock
 const getTons = async () => {
    fetch("https://app.ticketmaster.com/discovery/v2/events?apikey=XiNPWWR7685AFoobg27DG2naIh92yDVH&keyword=tons%20of%20rock&locale=*&countryCode=NO")
 ...
 const getSkei = async () => {
    fetch("https://app.ticketmaster.com/discovery/v2/events?apikey=XiNPWWR7685AFoobg27DG2naIh92yDVH&keyword=skeikampenfestivalen&locale=*&countryCode=NO")
      .then((response) => response.json()) 
  ...
  //NEON
  const getNeon = async () => {
    fetch("https://app.ticketmaster.com/discovery/v2/events?apikey=XiNPWWR7685AFoobg27DG2naIh92yDVH&keyword=neon&locale=*&countryCode=NO")
      .then((response) => response.json()) 
